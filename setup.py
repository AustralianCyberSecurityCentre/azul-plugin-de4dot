...
setup(
    name="azul-plugin-de4dot",
    description="Dotnet deobfuscator based on de4dot, used to be part of netalyser.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_de4dot"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-de4dot = azul_plugin_de4dot.main:main",
        ]
    },
